...
class RTMFPListener extends SessionListener<RTMFPResponder> {
	...
	public var stratusKey(default,null) : String;
	
	public function new( stream : jabber.Stream, handler : RTMFPResponder->Void, stratusKey : String ) {
	...
	override function createResponder() : RTMFPResponder {
		return new RTMFPResponder( stream, stratusKey );
	}
