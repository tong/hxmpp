...
/**
	Manages the spawning of virtual machines. <a href="http://xmpp.org/extensions/inbox/lop.html">Linked Process Protocol</a> <a href="http://linkedprocess.org">Linked Process Website</a>
